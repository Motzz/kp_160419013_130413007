...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Item Tag Values</h1>
        
         <br>
         <a href="{{route('ItemTagValues.create')}}" class="btn btn-primary btn-responsive">Tambah Item
    ...
    <div class="col-12">
       <table class="table">
                          ...
                          <tr>
                              ...
                              <td>  
                              <a href="{{route('ItemTagValues.show',[$data->ItemID])}}" class="btn btn-primary btn-responsive">Detail</a> 
                              <a href="{{route('ItemTagValues.edit',[$data->ItemID])}}" class="btn btn-secondary btn-responsive">
