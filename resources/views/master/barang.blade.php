...
<<<<<<< HEAD
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Barang
        </h1>
        <br>
       <a href="{{('/home/master/barang/tambah')}}" class="btn btn-primary btn-responsive">Tambah Barang
...
>>>>>>> c41f6cede0a380251b3de453180f62d6dcec8dcc
</div>
<!-- Content Row -->
<div class="container">
  <div class="row">
