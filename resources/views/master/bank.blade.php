...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="{{route('bank.create')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
        Tambah Bank <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle-fill" viewBox="0 0 16 16">
